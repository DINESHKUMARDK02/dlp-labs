...
```text
Lab-06-Custom-Sensitive-Information-Type-DLP/
│
├── README.md
│
├── sample-data/
...
│
└── screenshots/
    ├── 01-create-custom-sensitive-info-type.png
    ├── 02-configure-keyword-list.png
    ├── 03-configure-custom-regex-pattern.png
    ├── 04-review-custom-sit-pattern.png
    ├── 05-test-custom-sensitive-info-type.png
    ├── 06-create-dlp-policy-rule.png
    ├── 07-review-dlp-policy-settings.png
    ├── 08-policy-sync-completed.png
    ├── 09-upload-document-to-onedrive.png
    ├── 10-send-document-via-email.png
    ├── 11-email-blocked-by-dlp-policy.png
    ├── 12-email-dlp-alert.png
    ├── 13-share-document-via-teams.png
    ├── 14-teams-recipient-view.png
    ├── 15-teams-sharing-blocked-by-policy.png
    ├── 16-teams-dlp-alert.png
    ├── 17-activity-explorer-rule-match.png
    ├── 18-content-explorer-detected-sensitive-data.png
    └── 19-onedrive-dlp-alert-investigation.png
```
...
This lab can be expanded to include additional Microsoft Purview capabilities, such as:
...
- Power BI and Fabric Data Protection
